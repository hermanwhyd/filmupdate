...
import id.hw.labs.movieupdate.adapter.FavoriteTVShowAdapter;
import id.hw.labs.movieupdate.adapter.SearchTVShowsAdapter;
import id.hw.labs.movieupdate.adapter.TVShowsAdapter;
...
import id.hw.labs.movieupdate.utils.RecyclerColumnQty;
...
public class TVShowsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerColumnQty recyclerColumnQty = new RecyclerColumnQty(recyclerView.getContext(), R.layout.list_movie);
        gridLayoutManager = new GridLayoutManager(recyclerView.getContext(),recyclerColumnQty.calculateNoOfColumns());

        recyclerView.setLayoutManager(gridLayoutManager);
        adapter = new TVShowsAdapter(showsList,getContext());
    ...
    private void getShows(){
        ...
        switch (type) {
            ...
            case TYPE_FAVORITE:
                ...
                recyclerView.setAdapter(new FavoriteTVShowAdapter(getContext()));
                return;
        }
        ...
        call.enqueue(new Callback<ShowsList>() {
            ...
            public void onResponse(Call<ShowsList> call, Response<ShowsList> response) {
                ...
                if(recyclerView.getLayoutManager() == linearLayoutManager) recyclerView.setLayoutManager(gridLayoutManager);
                if(currentPage==1){
                    adapter=new TVShowsAdapter(showsList.getResults(),getContext());
                    recyclerView.setAdapter(adapter);
                } else {
        ...
        call.enqueue(new Callback<ShowsList>() {
            ...
            public void onResponse(Call<ShowsList> call, Response<ShowsList> response) {
                ...
                if(response.body().getResults().size()==0){
                    ...
                    txtNoResult.setVisibility(View.GONE);
                    recyclerView.setAdapter(new SearchTVShowsAdapter(response.body().getResults(),getContext()));
                }
            }
